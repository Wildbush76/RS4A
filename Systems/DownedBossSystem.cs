...
namespace RS4A.Systems
{
    ...
    {
        public static bool downedStupidBoss = false;
        // public static bool downedOtherBoss = false;

        public override void ClearWorld()
        {
            downedStupidBoss = false;
        ...
        {
            downedStupidBoss = tag.ContainsKey("downedStupidBoss");
