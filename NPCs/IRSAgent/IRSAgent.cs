namespace RS4A.NPCs.IRSAgent
{
    ...
    public class IRSAgent : ModNPC
    {
        ...
        public override string GetChat()//TODO create chat messages for the IRS agent
        {
        ...
        public override void AddShops()
        {
            ...
            new NPCShop(Type)
                .Add(new Item(ModContent.ItemType<Items.W2>())
                {
                    shopCustomPrice = 0
                })
        ...
        public override void ModifyActiveShop(string shopName, Item[] items)
        {
            ...
            var income = player.GetModPlayer<PlayerStuff.Income>();
            int taxes = income.OwedTaxes;
            if (taxes <= 0)
                items[0].TurnToAir();
            else
                items[0].shopCustomPrice = income.OwedTaxes;
